...
async function get_year_price(startyear, endyear, userId) {
    try {
        ...
        for (let year = startyear; year <= endyear; year++) {
            ...
            yearlyData.forEach(doc => {
                yearlyMap[doc.item_name] = doc.total;
            });
...
async function get_quarter_price(year, userId) {
    try {
        ...
        const result = quarters.map(quarter => {
            ...
            quarterData.forEach(doc => {
                quarterMap[doc.item_name] = doc.total;
            });
...
async function get_month_price(year, userId) {
    try {
        ...
        const result = months.map(month => {
            ...
            monthData.forEach(doc => {
                monthMap[doc.item_name] = doc.total;
            });
